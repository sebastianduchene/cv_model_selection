...
<run id=\"mcmc\" spec=\"MCMC\" chainLength=\"40000000\">
    <state id=\"state\" storeEvery=\"50000\">
        ...
        <stateNode id=\"expRateCategories.c:sequence_data\" spec=\"parameter.IntegerParameter\" dimension=\"48\">1</stateNode>
        <parameter id=\"birthRate2.t:sequence_data\" lower=\"0.0\" name=\"stateNode\" upper=\"10000.0\">1.0</parameter>
        <parameter id=\"relativeDeathRate2.t:sequence_data\" lower=\"0.0\" name=\"stateNode\" upper=\"1.0\">0.5</parameter>
        <parameter id=\"ucedMean.c:sequence_data\" name=\"stateNode\">1.0</parameter>
    </state>
    ...
    <distribution id=\"posterior\" spec=\"util.CompoundDistribution\">
        <distribution id=\"prior\" spec=\"util.CompoundDistribution\">
            ...
            <prior id=\"UCMeanRatePrior.c:sequence_data\" name=\"distribution\" x=\"@ucedMean.c:sequence_data\">
                <Uniform id=\"Uniform.02\" name=\"distr\" upper=\"Infinity\"/>
            </prior>
            <distribution id=\"all.prior\" spec=\"beast.math.distributions.MRCAPrior\" tree=\"@Tree.t:sequence_data\">
                <taxonset id=\"all\" spec=\"TaxonSet\">
...
<!--INPUT_CALIBRATION-->
        ...
        <distribution id=\"likelihood\" spec=\"util.CompoundDistribution\">
            <distribution id=\"treeLikelihood.sequence_data\" spec=\"TreeLikelihood\" data=\"@sequence_data\" tree=\"@Tree.t:sequence_data\">
                ...
                <branchRateModel id=\"ExponentialRelaxedClock.c:sequence_data\" spec=\"beast.evolution.branchratemodel.UCRelaxedClockModel\" clock.rate=\"@ucedMean.c:sequence_data\" rateCategories=\"@expRateCategories.c:sequence_data\" tree=\"@Tree.t:sequence_data\">
                    <Exponential id=\"Exponential.c:sequence_data\" name=\"distr\">
                        <parameter id=\"UCExpLambda.c:sequence_data\" name=\"mean\">1.0</parameter>
                    </Exponential>
                </branchRateModel>
            </distribution>
        </distribution>
    ...
    <operator id=\"ExpCategoriesRandomWalk.c:sequence_data\" spec=\"IntRandomWalkOperator\" parameter=\"@expRateCategories.c:sequence_data\" weight=\"10.0\" windowSize=\"1\"/>

    <operator id=\"ExpCategoriesSwapOperator.c:sequence_data\" spec=\"SwapOperator\" intparameter=\"@expRateCategories.c:sequence_data\" weight=\"10.0\"/>

    <operator id=\"ExpCategoriesUniform.c:sequence_data\" spec=\"UniformOperator\" parameter=\"@expRateCategories.c:sequence_data\" weight=\"10.0\"/>
    ...
    <operator id=\"ucedMeanScaler.c:sequence_data\" spec=\"ScaleOperator\" parameter=\"@ucedMean.c:sequence_data\" scaleFactor=\"0.5\" weight=\"1.0\"/>

    <operator id=\"relaxedUpDownOperatorExp.c:sequence_data\" spec=\"UpDownOperator\" scaleFactor=\"0.75\" weight=\"3.0\">
        <up idref=\"ucedMean.c:sequence_data\"/>
        <down idref=\"Tree.t:sequence_data\"/>
    </operator>
    ...
    <logger id=\"tracelog\" fileName=\"OUT_FILE_NAME.log\" logEvery=\"10000\" model=\"@posterior\" sanitiseHeaders=\"true\" sort=\"smart\">
        ...
        <log idref=\"treeLikelihood.sequence_data\"/>
        <log id=\"TreeHeight.t:sequence_data\" spec=\"beast.evolution.tree.TreeHeightLogger\" tree=\"@Tree.t:sequence_data\"/>
        <log id=\"rateStat.c:sequence_data\" spec=\"beast.evolution.branchratemodel.RateStatistic\" branchratemodel=\"@ExponentialRelaxedClock.c:sequence_data\" tree=\"@Tree.t:sequence_data\"/>
        <log idref=\"BirthDeath.t:sequence_data\"/>
        <log idref=\"birthRate2.t:sequence_data\"/>
        <log idref=\"relativeDeathRate2.t:sequence_data\"/>
        <log idref=\"all.prior\"/>
        <log idref=\"ucedMean.c:sequence_data\"/>
    </logger>
    ...
    <logger id=\"treelog.t:sequence_data\" fileName=\"OUT_FILE_NAME.trees\" logEvery=\"10000\" mode=\"tree\">
        <log id=\"TreeWithMetaDataLogger.t:sequence_data\" spec=\"beast.evolution.tree.TreeWithMetaDataLogger\" branchratemodel=\"@ExponentialRelaxedClock.c:sequence_data\" tree=\"@Tree.t:sequence_data\"/>
    </logger>
...
def make_strict(input_file):
    ...
    for TAXON in secs_data:
        ...
        calibration_blocks.append("<taxon id=\""+TAXON+"\" spec=\"Taxon\"/>")
    ...
    strict_step_3 = re.sub('<!--INPUT_CALIBRATION-->', calibration_block, strict_step_2)

    open(out_file_name+'.xml', 'w').writelines(strict_step_3)
...
def make_ucld(input_file):
    ...
    ucld_step_3 = re.sub('<!--INPUT_CALIBRATION-->', calibration_block, ucld_step_2)

    open(out_file_name+'.xml', 'w').writelines(ucld_step_3)

def make_exponential(input_file):
    secs_data = fasta_to_dict(input_file)
    taxon_blocks = list()
    calibration_blocks = list()
    ...
    exp_step_1 = re.sub('<!--INPUT_SEQUENCE_DATA-->', taxon_block, exponential_clock)
    out_file_name = re.sub('[.].+', '_exp', input_file)
    exp_step_2 = re.sub('OUT_FILE_NAME', out_file_name, exp_step_1)
    exp_step_3 = re.sub('<!--INPUT_CALIBRATION-->', calibration_block, exp_step_2)

    open(out_file_name+'.xml', 'w').writelines(exp_step_3)


make_strict(input_file)
make_ucld(input_file)
make_exponential(input_file)
